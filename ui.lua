...
do
	...
	local info = info or {}
        ...
        function window:Watermark(info)
            ...
            --
            utility:LoadImage(watermark__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
            --
        ...
        function window:NotificationList(info)
            ...
            function window.notificationlist:AddNotification(info)
                ...
                --
                utility:LoadImage(notify__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
                --
        ...
        function window:KeybindsList(info)
            ...
            --
            utility:LoadImage(keybindslist_gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
            --
            ...
            function window.keybindslist:Add(keybindname, keybindvalue)
                if keybindname and keybindvalue and not window.keybindslist.keybinds[keybindname] then
                    ...
                    --
                    utility:LoadImage(keybinds_gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
                    --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Textbox(info)
        ...
        --
        utility:LoadImage(text_gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
    ...
    function sections:Dropdown(info)
        ...
        --
        utility:LoadImage(dropdown_image, "arrow_down", "https://i.imgur.com/tVqy0nL.png")
        utility:LoadImage(dropdown__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + 15 +  20}) and not window:IsOverContent() then
                    if not multibox.open then
                        ...
                        for i,v in pairs(options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
                            --
    ...
    function sections:Box(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", "https://i.imgur.com/j9y4dux.png")
        --
